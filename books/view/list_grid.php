    ...
    <div id="category" class="grid_9">
      ...
      <div id="listing_options">
        ...
        <div id="view_mode" class="s_nav">
          <ul class="clearfix">
            <li id="view_grid" class="s_selected"><a href="listing_2.html"><span class="s_icon"></span>Grid</a></li>
            <li id="view_list"><a href="listing_1.html"><span class="s_icon"></span>List</a></li>
          </ul>
        </div>
      </div>
