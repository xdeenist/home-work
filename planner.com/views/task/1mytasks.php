...
<table width="100%">
  <tr>
    <td valign="top" width="50%">
      <div id="myGrid" style="width:650px;height:500px;margin-right:15px"></div>
...
var columns = [
  ...
  {id: "finish", name: "Pause", field: "finish", minWidth: 60, editor: Slick.Editors.Date},
  ...
  {id: "more", name: "More Inf", field: "More", width: 98, formatter: TaskMoreInf,}
];
